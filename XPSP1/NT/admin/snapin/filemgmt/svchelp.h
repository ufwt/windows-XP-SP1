...
#define IDH_223_242	242	// General: "Guests can use this volume" (Button)
...
const DWORD g_aHelpIDs_IDD_SHAREPROP_GENERAL[]=
{
	...
	242,	242,	// General: "Guests can use this volume" (Button)
...
{
    IDC_ALLOW_CACHING, IDC_ALLOW_CACHING,
    IDC_CACHE_SETTINGS_LABEL, IDC_CACHE_SETTINGS_LABEL,
    IDC_CACHE_OPTIONS, IDC_CACHE_OPTIONS,
    IDC_HINT, IDC_HINT,
