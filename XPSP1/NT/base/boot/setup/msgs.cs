...
Language=English
Instalace se nepodaıila. Libovolnou kl vesou restartujte poŸ¡taŸ.
.
...
m te-li disketu s podporou dan‚ho zaı¡zen¡ od vìrobce adapt‚ru.
...
Windows pomoc¡ diskety s podporou zaı¡zen¡ od vìrobce adapt‚ru.

Vyberte po§adovanì adapt‚r SCSI z n sleduj¡c¡ho seznamu, nebo se
stisknut¡m kl vesy ESC vraœte na pıedchoz¡ obrazovku.

.
MessageID=9038 SymbolicName=SL_PROMPT_HAL
Language=English
InstalaŸn¡mu programu se nepodaıilo urŸit typ poŸ¡taŸe, nebo byla 
zvolena mo§nost typ poŸ¡taŸe zadat ruŸnØ.

Vyberte typ poŸ¡taŸe z n sleduj¡c¡ho seznamu, nebo zvolte "Jinì",
m te-li disketu s podporou zaı¡zen¡ od vìrobce poŸ¡taŸe.
...
pomoc¡ diskety s podporou zaı¡zen¡ od vìrobce poŸ¡taŸe.

Zadejte typ poŸ¡taŸe z n sleduj¡c¡ho seznamu, nebo se stisknut¡m
tlaŸ¡tka ESC vraœte na pıedchoz¡ obrazovku.
...
Language=English
InstalaŸn¡mu programu se nepodaıilo urŸit typ nainstalovan‚ho 
grafick‚ho adapt‚ru.

Vyberte grafickì adapt‚r ze seznamu, nebo zvolte "Jinì",
m te-li disketu s podporou zaı¡zen¡ od vìrobce adapt‚ru.
...
pomoc¡ diskety s podporou zaı¡zen¡ od vìrobce adapt‚ru.
...
Language=English
Pıi pı¡stupu k souboru %s doçlo k V/V chybØ.
...
Language=English
SETUPLDR: Jednotku %s nelze otevı¡t
.
...
Language=English
Tuto disketu nelze pıeŸ¡st, proto§e obsahuje nerozpoznanì syst‚m soubor….
...
Language=English
Chcete-li nainstalovat jin‚ ovladaŸe zaı¡zen¡ SCSI nebo RAID, stisknØte F6...
.
...
Language=English
S=Specifikovat dalç¡ zaı¡zen¡   ENTER=PokraŸovat   F3=Konec
.

MessageID=9062 SymbolicName=SL_SCSI_SELECT_MESSAGE_2
Language=English
  * Chcete-li specifikovat dalç¡ adapt‚ry SCSI, jednotky CD-ROM, nebo 
    speci ln¡ ıadiŸe disk… pro pou§it¡ v syst‚mu Windows, 
    vŸetnØ tØch, pro nØ§ m te disketu s podporou zaı¡zen¡ od vìrobce 
    velkokapacitn¡ch ukl dac¡ch zaı¡zen¡, stisknØte kl vesu S.

  * Pokud nem te disketu s podporou zaı¡zen¡ od vìrobce velkokapacitn¡ch
    zaı¡zen¡, nebo nechcete specifikovat § dn‚ dalç¡ zaı¡zen¡ pro 
...
zaı¡zen¡, nainstalovanìch v syst‚mu, nebo byla zvolena mo§nost urŸit 
adapt‚r ruŸnØ. InstalaŸn¡ program nyn¡ naŸte podporu n sleduj¡c¡ch 
velkokapacitn¡ch ukl dac¡ch zaı¡zen¡:
.
...
ukl dac¡ zaı¡zen¡. InstalaŸn¡ program nyn¡ naŸte podporu n sleduj¡c¡ch 
velkokapacitn¡ch ukl dac¡ch zaı¡zen¡:
.
...
Language=English
OvladaŸ rozç¡ıen¡ PCI IDE
.

MessageID=9072 SymbolicName=SL_HW_FW_CFG_CLASS
Language=English
Syst‚m Windows se nepodaıilo spustit z d…vodu n sleduj¡c¡ho
...
Dalç¡ informace naleznete v pı¡ruŸk ch k hardwaru.
.
...
Pozn mka: VìbØrem pı¡sluçn‚ polo§ky spouçtØc¡ obrazovky m¡sto vìchoz¡
polo§ky Instalace syst‚mu Windows m…§ete spustit pıedchoz¡ instalace
...
Language=English
Poskytnutì ovladaŸ je pravdØpodobnØ novØjç¡ ne§ vìchoz¡ ovladaŸ syst‚mu Windows.
.
...
Language=English
Pı¡prava Automatick‚ho obnoven¡ syst‚mu (ASR) (zruçit m…§ete kl vesou ESC)...
.
...
Language=English
SpouçtØn¡ pıedinstalaŸn¡ho prostıed¡ syst‚mu Windows...
.
...
Language=English
NaŸten¡ ovladaŸ… vìrobce OEM se nezdaıilo.
...
Language=English
Pıi spouçtØn¡ syst‚mu z ramdisku doçlo k chybØ. Syst‚m Windows nelze spustit.
.

MessageID=15003 SymbolicName=BL_RAMDISK_BOOT_FAILURE
Language=English
Otevıen¡ bitov‚ kopie ramdisku se nezdaıilo.
.
