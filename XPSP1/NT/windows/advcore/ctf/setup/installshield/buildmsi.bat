...
"C:\Program Files\InstallShield\InstallShield for Windows Installer\System\ISCmdBld.exe" -p "C:\NT6\Windows\AdvCore\CTF\setup\InstallShield\MSI.ism" -r "CIC" -d "Cicero" -c COMP -a "CIC"
